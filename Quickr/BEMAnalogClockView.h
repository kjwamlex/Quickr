...
@property (nonatomic) BOOL enableotherhub;
...
@property (strong, nonatomic) UIColor *otherhubColor;

@property (nonatomic) CGFloat otherhubalpha;

@property (nonatomic) CGFloat otherhubradius;
