...
- (void)viewDidLoad
{
    ...
    self.myClock1.digitFont = [UIFont fontWithName:@"AppleSDGothicNeo-SemiBold" size:17];
    self.myClock1.digitColor = [UIColor whiteColor];
    self.myClock1.enableDigit = YES;
    self.myClock1.enableHub = YES;
    self.myClock1.enableotherhub = YES;
    ...
    self.myClock2.borderColor = [UIColor colorWithRed:0 green:122.0/255.0 blue:255/255 alpha:0];
    self.myClock2.hourHandColor = [UIColor whiteColor ];
    self.myClock2.minuteHandColor = [UIColor colorWithRed:0 green:122.0/255.0 blue:255/255 alpha:0];
